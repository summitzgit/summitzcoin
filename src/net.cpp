...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Summitzcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"52.194.190.29", "52.194.190.29"},
    {"13.231.233.48", "13.231.233.48"},
    {"13.114.99.240", "13.114.99.240"},
    {NULL, NULL}
};
...
unsigned int pnSeed[] =
{   
    0x1dbec234, 0x30e9e70d, 0xf063720d
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Summitzcoin is probably already running."), addrBind.ToString().c_str());
        else
